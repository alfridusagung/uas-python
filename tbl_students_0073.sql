...
--
-- Database: `db_akademik_0073`
--

-- --------------------------------------------------------

--
-- Table structure for table `tbl_students_0073`
--

CREATE TABLE `tbl_students_0073` (
  `no` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0073`
--

INSERT INTO `tbl_students_0073` (`no`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0073`
--
ALTER TABLE `tbl_students_0073`
  ADD PRIMARY KEY (`no`);
...
--
-- AUTO_INCREMENT for table `tbl_students_0073`
--
ALTER TABLE `tbl_students_0073`
